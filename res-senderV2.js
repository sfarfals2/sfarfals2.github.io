...
function askCoordinate() {
    ...
    <center><img id="sophieImg" class="tooltip-delayed"
       ...
       src="https://web.archive.org/web/20250601123240/https://dl.dropboxusercontent.com/s/bxoyga8wa6yuuz4/sophie2.gif"
       style="cursor:help; position: relative"></center>
    <br>
    <center>
       <p>${langShinko[3]}: <a
          href="https://web.archive.org/web/20250601123240/https://shinko-to-kuma.my-free.website/"
    ...
    if (game_data.locale == "ar_AE") {
        $("#sophieImg").attr("src", "https://web.archive.org/web/20250601123240/https://media2.giphy.com/media/qYr8p3Dzbet5S/giphy.gif");
    }
...
/*
     FILE ARCHIVED ON 12:32:40 Jun 01, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:54:22 Jul 14, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 136.941
  LoadShardBlock: 478.153 (3)
  PetaboxLoader3.resolve: 421.751 (4)
  PetaboxLoader3.datanode: 144.096 (5)
  load_resource: 105.721
  loaddict: 36.677
*/
